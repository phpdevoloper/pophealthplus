...
class Register_List_Table extends WP_List_Table
{
    ...
    function prepare_items()
    {
        ...
        $query = "SELECT * FROM ". $wpdb->prefix ."register";
...
add_action('admin_menu', 'register_list');

/*
    *** Admin menu
*/
function register_list() {
    $page_title = 'Register List';
    $menu_title = 'Register List';
    $capability = 'moderate_comments';
    $menu_slug = 'registerlist';
...
function registerResult()
{
    $wp_list_table = new Register_List_Table();
